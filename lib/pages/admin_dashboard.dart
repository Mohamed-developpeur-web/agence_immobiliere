      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            ...
            Text('Admin — ${user?.pseudo ?? "Bienvenue"}'),
          ],
        ),
      ),
      body: Column(
            ...
            child: Padding(
              ...
              child: GridView.count(
                ...
                children: [
                  ...
                  _card(context, Icons.description, "Contrats", "/contrats", Colors.orange),
                  _card(context, Icons.manage_accounts, "Gérer utilisateurs", "/manageUsers", Colors.deepPurple),
                  _card(context, Icons.analytics_outlined, "Rapports", "/rapports", Colors.pink),
